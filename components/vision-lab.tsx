...
import type { VisionCropPreset, VisionLabController, VisionResolvedEvent } from "@/lib/vision-lab-types";
    ...
    <div className={styles.workspace}>
      <aside className={styles.setup} aria-label="素材与计时门设置">
        <section className={styles.panel}>
          ...
          {lab.reference ? <VisionReferenceSelection reference={lab.reference} disabled={locked} onChange={lab.setReferenceRect} /> : <div className={styles.referenceEmpty}><Icon name="expand" size={32} /><b>圈出你的起终点门</b><span>完整门框与清晰纹理有助于匹配</span></div>}
